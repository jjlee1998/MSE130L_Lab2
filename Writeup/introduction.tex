...
%
	...
	\end{equation}
%
For the Fe/H corrosion couple, the $nF/RT$ prefactor has a value of 77.85 V$^{-1}$ at 25\textdegree{C}. The corrosion potential may therefore be determined by a linear fit to a "Linear Polarization Resistance" (LPR) scan at small overpotentials (colloqually defined as $|\eta| < 100$ mV).\cite{gsi}
